...
public final class Forum {
    ...
    public Forum() {
        ...
        this.userList.add(new ForumUser("005", "Kinia", 'F', LocalDate.of(2000, 8, 5), 751));
        this.userList.add(new ForumUser("006", "Lena", 'F', LocalDate.of(1991, 4, 14), 141));
        this.userList.add(new ForumUser("007", "NoName1", 'M', LocalDate.of(1990, 5, 15), 0));
        this.userList.add(new ForumUser("008", "NoName2", 'F', LocalDate.of(1991, 4, 14), 0));
    }
